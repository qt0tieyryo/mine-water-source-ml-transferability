...
- `requirements-lock.txt`: Full pinned environment (all transitive dependencies) for strict reproduction.

## Data availability

The hydrochemical datasets used in this study (training, internal test, and external validation sets) were obtained from mine hydrogeological surveys and are subject to data-sharing restrictions. They are available from the corresponding author on reasonable request and subject to approval by the data-owning parties.
...
If you use this code, please cite the manuscript (full citation to be added on acceptance) and this archived repository:

> [Author list] (2026) Limited cross-mine transferability of machine learning models for mine water inrush source identification: an independent external validation. Earth Science Informatics (under review).

Archived release: Zenodo, https://doi.org/10.5281/zenodo.XXXXXXX (replace with your DOI after creating the GitHub release).
